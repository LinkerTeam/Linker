...
public class CardController {
	...
	public ResponseEntity<CardVO> updateCardStatus(@PathVariable("p_id") Integer p_id, 
			@PathVariable("id") Integer id, @RequestBody CardVO vo) {
		...
		try {
			...
			entity = new ResponseEntity<CardVO>(service.readPopcard(vo), HttpStatus.OK);
		} catch (Exception e) {
			e.printStackTrace();
	...
	public ResponseEntity<List<ReadCardlistVO>> statusCardList(@PathVariable("p_id") int p_id, @PathVariable("ps_id") int ps_id) {
	...
	public ResponseEntity<List<ReadCardlistVO>> listCards(@PathVariable("p_id") int p_id, @PathVariable("cl_id") int cl_id) {
		ResponseEntity<List<ReadCardlistVO>> entity = null;
